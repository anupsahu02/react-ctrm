...
import { derivativeService } from "../../../_services/"
...
class futuresListing extends Component {
    ...
    componentDidMount() {
        derivativeService.getAll().then(data => this.setState({ data: data }));
    }
    ...
    render() {
        ...
        return ( <
            ...
            <
            h3 className = "content-header-title" > Future Trades < /h3> <
            ...
            li > <
            li className = "breadcrumb-item active" > Future Trades < /li> < /
            ol > <
            /div> < /
            div > <
            /div> < /
